...
struct Z_Construct_UClass_AMovingPlatform_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_MyVectorY_MetaData[] = {
		{ "Category", "MovingPlatform" },
		{ "ModuleRelativePath", "MovingPlatform.h" },
	};
#endif // WITH_METADATA
	static const UECodeGen_Private::FStructPropertyParams NewProp_MyVector;
	static const UECodeGen_Private::FFloatPropertyParams NewProp_MyVectorY;
...
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_AMovingPlatform_Statics::NewProp_MyVectorY = { "MyVectorY", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AMovingPlatform, MyVectorY), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_MyVectorY_MetaData), NewProp_MyVectorY_MetaData) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_AMovingPlatform_Statics::PropPointers[] = {
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AMovingPlatform_Statics::NewProp_MyVectorY,
};
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_Projects_Unreal_5_ObstacleAssault_Source_ObstacleAssault_MovingPlatform_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AMovingPlatform, AMovingPlatform::StaticClass, TEXT("AMovingPlatform"), &Z_Registration_Info_UClass_AMovingPlatform, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AMovingPlatform), 2006341416U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Projects_Unreal_5_ObstacleAssault_Source_ObstacleAssault_MovingPlatform_h_3242282794(TEXT("/Script/ObstacleAssault"),
	Z_CompiledInDeferFile_FID_Projects_Unreal_5_ObstacleAssault_Source_ObstacleAssault_MovingPlatform_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Projects_Unreal_5_ObstacleAssault_Source_ObstacleAssault_MovingPlatform_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
